...
public class ClientMain {
    ...
    if (args.length == 4) {
    	if (args[3].equals("enc")) {
        System.out.println("Szyfrowanie : TAK");
        enc = true;
    	}
    	else {
    	System.out.println("Podano błędne parametry. Podaj prawidlowe parametry: [username] [ip_serwera] [port_serwera] (opcjonalnie) Szyfrowanie[wpisz enc]");  
        System.exit(0);
    }}    	
